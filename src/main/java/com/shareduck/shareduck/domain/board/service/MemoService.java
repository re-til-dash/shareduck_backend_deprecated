...
public class MemoService {
    ...
    public Page<MemoRes> getMemosBySearchConditions(CurrentUser currentUser, MemoSearchConditions memoSearchConditions,
                                                    Pageable pageable) {
        if (memoSearchConditions.categoryId() != null) {
            categoryService.findCategoryByIdAndCheckAccess(memoSearchConditions.categoryId(), currentUser);
        }
        Page<Memo> memos = memoRepository.findMemoBySearchCondition(currentUser, memoSearchConditions, pageable);
